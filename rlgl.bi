...
declare function rlEnableVertexArray(byval vaoId as ulong) as byte
...
declare sub rlColorMask(byval r as byte, byval g as byte, byval b as byte, byval a as byte)
...
declare function rlIsStereoRenderEnabled() as byte
...
declare function rlCheckRenderBatchLimit(byval vCount as long) as byte
declare sub rlSetTexture(byval id as ulong)
declare function rlLoadVertexArray() as ulong
declare function rlLoadVertexBuffer(byval buffer as const any ptr, byval size as long, byval dynamic as byte) as ulong
declare function rlLoadVertexBufferElement(byval buffer as const any ptr, byval size as long, byval dynamic as byte) as ulong
...
declare sub rlSetVertexAttribute(byval index as ulong, byval compSize as long, byval type as long, byval normalized as byte, byval stride as long, byval pointer as const any ptr)
...
declare function rlLoadTextureDepth(byval width as long, byval height as long, byval useRenderBuffer as byte) as ulong
...
declare function rlFramebufferComplete(byval id as ulong) as byte
...
declare sub rlBindImageTexture(byval id as ulong, byval index as ulong, byval format as long, byval readonly as byte)
